...
const Register = (props) => {
    ...
    const registerUser = async (e) => {
        ...
        try {
            toggleSpinner();
            const authUserCreated = await auth.createUserWithEmailAndPassword(email, password)
                ...
                <form className='register-form' onSubmit={registerUser}>
                    ...
                    <Container>
                        <Row className="justify-content-md-center">
                            ...
                            <Col md='auto' className='padding'>
                                <CustomTextField name='age'
                                    ...
                                    onChange={onChangeHandler} value={age}
                        ...
                        <Row className="justify-content-md-center">
                            ...
                            <Col md='auto' className='padding'>
                                <CustomTextField name='confPassword'
                                    showError={clicked.confPassword && errors.confPassword}
                                    type='password'
                                    label='Confirm Password'
                                    errorMessage="Forgot already? &#x1F616;"
                                    onChange={onChangeHandler} value={confPassword}
                                />
                            </Col>
                        </Row>
                    </Container>
                    <div className='center'>
                        <CustomButton type="btnup large padding"
