...
import { auth, firestore, signInWithGmail } from '../../firebase/firebase.config'
    ...
    signIn = async (e) => {
        ...
        if (!showError.email && !showError.password && email.length > 0) {
            ...
            try {
                ...
                this.setState({ msg: err.message, showMsgBox: true, status: 'error', password: '' })
            }
        }
        else {
            this.setState({
    ...
    render() {
        ...
        return (
            <>
                {
                    showMsgBox ?
                        <MsgPopup status={status} onClick={
                            () => {
                ...
                <div className='signin'>
                    ...
                    <div className='title'>
                        ...
                        <CustomHeading>Email and Password,<br /> You must Enter</CustomHeading>
                    </div>

                    <form className='form'>
                        <CustomTextField type='email' name='email'
                        ...
                        <div className='clump-together'>
                            <CustomButton type='cus-btn large btndown'
                                onClick={this.signIn}>SIGN IN</CustomButton>
