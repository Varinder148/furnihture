...
import { faCheck, faCross, faExclamationCircle } from '@fortawesome/free-solid-svg-icons'
            ...
            <div className='msgPopup' >
                ...
                <div className={`content ${status}`} >
                    <span className='icon ' hidden={status !== 'payment'}>
                        <img src='https://i.imgflip.com/5azowq.jpg'>
                    ...
                    <span className='icon ' hidden={!(status === 'success' || status==='payment')}>
