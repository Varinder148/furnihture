...
import { faAddressCard, faAngleDoubleRight, faBars, faShoppingBag, faShoppingCart, faTimes, faWindowClose } from '@fortawesome/free-solid-svg-icons'
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(HorizontalMenu));