...
import { addItem, emptyCart, removeItem, removeOneItem } from '../../redux/cart/cart.action'
import { createStructuredSelector } from 'reselect'
import { hideCart, selectedCartItems, totalCartAmount } from '../../redux/cart/cart.selectors'
import { currUser } from '../../redux/user/user.selectors'
import MsgPopup from '../msgPopup/msgPopup.component'


const CheckoutTable = ({ total, removeOneItem, loggedInUser, emptyCart, removeItem, hidden, addItem, cartItems, ...others }) => {
    // let total = 0;
