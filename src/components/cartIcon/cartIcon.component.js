...
cartItemsCount : cartItems.reduce((count, cartItem)=> count+cartItem.quantity,0),
hidden: hidden
})

export default connect(mapPropsToDispatch,mapDispatchToProps)(withRouter(CartIcon))